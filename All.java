		...
		else if(ae.getSource()==ok)
		{
			if(fybsc.isSelected()||sybsc.isSelected()||tybsc.isSelected()||fymsc.isSelected()||symsc.isSelected()||fymca.isSelected()||symca.isSelected()||tymca.isSelected())
			{
					if(fybsc.isSelected())
						...
						table_class="TYMCA";
				frm.dispose();
				if(MainFrame.markinfo==1 && MainScreen.post!=3)
					new AllRecords();
				else if(MainFrame.markinfo==0 && MainScreen.post!=3)
					new AllStudent();
				else if(MainScreen.post==3)
					new Summery();
			}
			else 
