	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(ae.getSource()==ok)
		{
			...
			try
			{
				...
				PreparedStatement pst=DB.cn.prepareStatement("delete from stud where rno=? and cname=?");
				
				pst.setInt(1,rno);
				pst.setString(2,cls);
				pst.executeUpdate();
				
				PreparedStatement pst1=DB.cn.prepareStatement("delete from stud_sub where rno=? and cname=?");
				pst1.setInt(1,rno);
				pst1.setString(2,cls);
				pst1.executeUpdate();
